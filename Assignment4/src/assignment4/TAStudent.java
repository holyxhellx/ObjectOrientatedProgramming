...
public class TAStudent extends Student {
    ...
    public TAStudent(String name, String subject, int group) {
        this.name = name;
    ...
    //Methods
    public boolean equals(TAStudent anotherStudent) {
    ...
    public String toString() {
        return "TA Student " + this.name + " is doing research in " + this.subject;
    }
}
